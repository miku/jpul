...
class JobController extends Controller
{
    ...
    public function actionIndex($page = 1, $sort = null, $v = "browser", $tab = 'all') {
        ...
        if ($v == "browser") {
            ...
            $this->pageTitle = 'Jobportal der Universität Leipzig (Stellenangebote, Praktika, Stipendien, WHK, SHK, ...)'; // ' (' . $total . ' aktuelle Jobangebote)';
    ...
    public function actionSearchHits($q = '', $tab = 'all', $format = 'plain') {
