...
<?php if (isset(Yii::app()->session[Yii::app()->params['favStore']]) && in_nested_array($model->id, Yii::app()->session[Yii::app()->params['favStore']])): ?>
...
<?php endif ?>
	...
	<p>
		<span class="post-location"><?php echo cut_text(format_model_location($model), 60); ?> &middot;</span>
