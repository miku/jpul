...
<?php endif ?>
	...
	<td class="job-title">
		<a href="<?php echo $this->createUrl('job/view', array('id' => $model->id)); ?>" title="<?php echo $this->cut_text($model->description, 300) ?>">
			<?php echo $this->cut_text($model->title, 40) ?>
		</a>
	</td>
	<td class="job-company"><?php echo $this->cut_text($model->company, 20) ?></td>
