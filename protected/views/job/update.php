...
?>
	...
	<table border="0" cellspacing="2" cellpadding="4">
		...
		<tr class="even"><td><?php echo $form->error($model,'title'); ?></td></tr>
		...
		<tr class="even"><td><?php echo $form->error($model,'description'); ?></td></tr>
		...
		<tr class="even"><td><?php echo $form->error($model,'company'); ?></td></tr>
		...
		<tr class="even"><td><?php echo $form->error($model,'company_homepage'); ?></td></tr>
		...
		<tr class="even"><td><?php echo $form->error($model,'zipcode'); ?></td></tr>
		...
		<tr class="even"><td><?php echo $form->error($model,'city'); ?></td></tr>
		...
		<tr class="even"><td><?php echo $form->error($model,'state'); ?></td></tr>
		...
		<tr class="even"><td><?php echo $form->error($model,'country'); ?></td></tr>
		...
		<tr class="even"><td><?php echo $form->error($model,'study'); ?></td></tr>
		...
		<tr class="even"><td><?php echo $form->error($model,'sector'); ?></td></tr>
