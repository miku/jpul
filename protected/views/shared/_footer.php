...
<div class="column-210">    
    <ul class="example-searches">
        ...
        array("tab" => $tab, "src" => "eq", "q" => 
            "french+OR+franz&ouml;sisch+OR+spanish+OR+spanisch+OR+chinese+OR+chinesisch+OR+russian+OR+russisch+OR+turkish+OR+t&uuml;&auml;nisch+OR+ukrainian+OR+ukrainisch+OR+arabic+OR+arabisch+OR+farsi+OR+persisch"))); ?>">Sprachen außer Englisch</a></li>
...
<p>
    <strong>Micro&mdash;Jobportal</strong> &middot;
