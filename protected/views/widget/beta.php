...
<table border="0" cellspacing="3" cellpadding="3">
	...
	<tr><td>Internet Explorer 7</td>		<td><a href="<?php echo $this->createUrl('feedback/index', array('context' => 'widget-compat')); ?>">?</a></td><td>&mdash;</td><td>&mdash;</td></tr>
	...
	<tr><td>Internet Explorer 9</td>		<td><a href="<?php echo $this->createUrl('feedback/index', array('context' => 'widget-compat')); ?>">?</a></td><td>&mdash;</td><td>&mdash;</td></tr>
	<tr><td>Firefox 3.6</td>				<td><a href="<?php echo $this->createUrl('feedback/index', array('context' => 'widget-compat')); ?>">?</a></td><td><span style="background:green; color:white; font-size:8px; padding: 2px;">OK</span></td><td><a href="<?php echo $this->createUrl('feedback/index', array('context' => 'widget-compat')); ?>">?</a></td></tr>
	<tr><td>Firefox 4</td>					<td><a href="<?php echo $this->createUrl('feedback/index', array('context' => 'widget-compat')); ?>">?</a></td><td><a href="<?php echo $this->createUrl('feedback/index', array('context' => 'widget-compat')); ?>">?</a></td><td><a href="<?php echo $this->createUrl('feedback/index', array('context' => 'widget-compat')); ?>">?</a></td></tr>	
	<tr><td>Firefox 5</td>					<td><span style="background:green; color:white; font-size:8px; padding: 2px;">OK</span></td><td><a href="<?php echo $this->createUrl('feedback/index', array('context' => 'widget-compat')); ?>">?</a></td><td><a href="<?php echo $this->createUrl('feedback/index', array('context' => 'widget-compat')); ?>">?</a></td></tr>
	<tr><td>Safari 5.0.5</td>				<td><a href="<?php echo $this->createUrl('feedback/index', array('context' => 'widget-compat')); ?>">?</a></td><td><span style="background:green; color:white; font-size:8px; padding: 2px;">OK</span></td><td><a href="<?php echo $this->createUrl('feedback/index', array('context' => 'widget-compat')); ?>">?</a></td></tr>
	<tr><td>Chrome 12</td>      			<td><span style="background:green; color:white; font-size:8px; padding: 2px;">OK</span></td><td><a href="<?php echo $this->createUrl('feedback/index', array('context' => 'widget-compat')); ?>">?</a></td><td><a href="<?php echo $this->createUrl('feedback/index', array('context' => 'widget-compat')); ?>">?</a></td></tr>	
	<tr><td>Chrome 14</td>      			<td><a href="<?php echo $this->createUrl('feedback/index', array('context' => 'widget-compat')); ?>">?</a></td><td><span style="background:green; color:white; font-size:8px; padding: 2px;">OK</span></td><td><a href="<?php echo $this->createUrl('feedback/index', array('context' => 'widget-compat')); ?>">?</a></td></tr>
	<tr><td>Camino 2.0.7</td>   			<td>&mdash;</td><td><span style="background:green; color:white; font-size:8px; padding: 2px;">OK</span></td><td><a href="<?php echo $this->createUrl('feedback/index', array('context' => 'widget-compat')); ?>">?</a></td></tr>
</table>
