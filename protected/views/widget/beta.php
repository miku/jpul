...
<table border="0" cellspacing="3" cellpadding="3">
	...
	<tr><td>Opera 11</td>					<td><span style="background:orange; color:white; font-size:8px; padding: 2px;">nope</span></td><td><span style="background:green; color:white; font-size:8px; padding: 2px;">OK</span></td><td><a href="<?php echo $this->createUrl('feedback/index', array('context' => 'widget-compat')); ?>"><span style="font-size:8px">not yet tested</span></a></td></tr>	
	...
	<tr><td>Camino 2.0.7</td>   			<td>&mdash;</td><td><span style="background:green; color:white; font-size:8px; padding: 2px;">OK</span></td><td><a href="<?php echo $this->createUrl('feedback/index', array('context' => 'widget-compat')); ?>"><span style="font-size:8px">not yet tested</span></a></td></tr>
